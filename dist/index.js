...
const debug = __nccwpck_require__(237)('background-server-action');
const cliParser = __nccwpck_require__(99)();
const quote = __nccwpck_require__(55);

const { ping } = __nccwpck_require__(390)
...
const debug = __nccwpck_require__(237)('@cypress/github-action')
